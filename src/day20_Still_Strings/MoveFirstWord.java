...
public class MoveFirstWord {
    ...
    public static void main(String[] args) {
        ...
        String firsWord = sentence.substring(0, spaceIndex);

        String result = sentence.substring(spaceIndex + 1) + " " + firsWord;
        //String result = sentence.substring(spaceIndex).trim() + " " + firsWord;
