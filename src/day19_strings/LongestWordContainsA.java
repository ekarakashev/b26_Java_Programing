...
public class LongestWordContainsA {
    /*
    ...
    public static void main(String[] args) {
        ...
        if (a1 && a2) {
            if ((a >= b || !b1 || !b2) && (a >= c || !c1 || !c2)) {
                System.out.println(word1 + message);
            }
        }
        if ((b1 && b2)) {
